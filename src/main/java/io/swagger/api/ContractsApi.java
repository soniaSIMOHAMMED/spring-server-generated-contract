...
"admin"        })    }, tags={ "Create/Lifecycle" })
    ...
    ResponseEntity<ContractRequest> postContract(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @RequestBody ContractRequest body) throws IOException;
